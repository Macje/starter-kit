		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Title1",
									"targetURL": "#stkstarterkit1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"stkstarterkit1-display": {
								"semanticObject": "stkstarterkit1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=stk.starterkit1",
									"url": sap.ui.require.toUrl("stk/starterkit1")
								}
							}
						}
					}
